...
! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "object" == typeof exports ? exports.io = e() : t.io = e()
}(this, function() {
    return function(t) {
        function e(n) {
                        ...
                        if ((d = m.hasOwnProperty) || (d = function(t) {
                            ...
                            var N = {
                                ...
                                D = function(t, e, r, n, o, i, s) {
                                    ...
                                    if ("object" == typeof a && a)
                                        if (c = v.call(a), c != k || d.call(a, "toJSON")) "function" == typeof a.toJSON && (c != A && c != x && c != B || d.call(a, "toJSON")) && (a = a.toJSON(t));
                                        else if (a > -1 / 0 && a < 1 / 0) {
                                        if (_) {
                                    ...
                                    if (c == A) return a > -1 / 0 && a < 1 / 0 ? "" + a : "null";
                                    if (c == x) return R("" + a);
                                    if ("object" == typeof a) {
                                        for (P = s.length; P--;)
                                            if (s[P] === a) throw p();
                            ...
                            e.stringify = function(t, e, r) {
                                ...
                                if (s[typeof e] && e)
                                    ...
                                    i = {};
                                    for (var c, u = 0, h = e.length; u < h; c = e[u++], a = v.call(c), (a == x || a == A) && (i[c] = 1));
                                }
                                if (r)
                                    if ((a = v.call(r)) == A) {
                                        if ((r -= r % 1) > 0)
...
___browserSync___.host = window.BS_HOST || location.host;
___browserSync___.url = '' + ___browserSync___.host + '/browser-sync';
...
! function t(e, n, o) {
    ...
    1: [function(t, e, n) {
        ...
        function r(t, e) {
            for (var n = 0, o = e.split("."), r = o.length; r > n; n++) {
        ...
        var i = t("./socket"),
            ...
            a = function(t) {
                this.options = t, this.socket = i, this.emitter = s, this.utils = c, this.tabHidden = !1;
                var e = this;
                i.on("options:set", function(t) {
        ...
        a.prototype.canSync = function(t, e) {
            ...
            if (t && t.match(/\./)) return r(this.options, t);
    ...
    2: [function(t, e, n) {
        ...
        o.getWindow = function() {
            ...
            var t, e, o = n.getWindow(),
                ...
                i = r.documentElement,
                s = r.body;
            return void 0 !== o.pageYOffset ? (t = o.pageXOffset, e = o.pageYOffset) : (t = i.scrollLeft || s.scrollLeft || 0, e = i.scrollTop || s.scrollTop || 0), {
                x: t,
                y: e
            }
        ...
        }, o.getLocation = function(t) {
            var e = o.getDocument().createElement("a");
    ...
    3: [function(t, e, n) {
        "indexOf" in Array.prototype || (Array.prototype.indexOf = function(t, e) {
            ...
            for (arguments.length > 1 && (n = e), o = new Array(s), r = 0; s > r;) {
                var c, a;
                r in i && (c = i[r], a = t.call(n, c, r, i), o[r] = a), r++
            }
            return o
            ...
            for (var o = [], r = arguments.length >= 2 ? arguments[1] : void 0, i = 0; n > i; i++)
                if (i in e) {
                    var s = e[i];
    ...
    4: [function(t, e, n) {
        ...
        c.init = function(t) {
            t.options.tagNames && (a.tagNames = t.options.tagNames), "window.name" === t.options.scrollRestoreTechnique ? c.saveScrollInName(s) : c.saveScrollInCookie(i.getWindow(), i.getDocument()), t.socket.on("file:reload", c.reload(t)), t.socket.on("browser:reload", function() {
                t.canSync({
                    url: u()
            ...
            r.bs && r.bs.hardReload && r.bs.scroll && i.setScroll(r.bs.scroll), o.name = o.name.replace(n, "")
        }, c.saveScrollInCookie = function(t, e) {
            i.isOldIe() && ("complete" === e.readyState ? i.restoreScrollPosition() : r.manager.addEvent(e, "readystatechange", function() {
                "complete" === e.readyState && i.restoreScrollPosition()
            }), s.on("browser:hardReload", i.saveScrollPosition))
        }, c.updateSearch = function(t, e, n) {
            ...
            var r = t[e],
                ...
                l = a + "=" + s,
                u = i.getLocation(r),
                f = c.updateSearch(u.search, a, l);
            n.timestamps === !1 ? t[e] = u.href : t[e] = u.href.split("?")[0] + f;
            var d = document.body;
            return setTimeout(function() {
                o ? (o.style.display = "none", o.style.display = "block") : (o = document.createElement("DIV"), d.appendChild(o))
            }, 200), {
                elem: t,
                timeStamp: s
            }
            ...
            return function(e) {
                if (t.canSync({
                    ...
                    if ((e.url || !o.injectChanges) && c.reloadBrowser(!0), e.basename && e.ext) {
                        var i = c.getElems(e.ext),
                            s = c.getMatches(i.elems, e.basename, i.attr);
                        s.length && o.notify && r.emit("notify", {
                            message: "Injected: " + e.basename
                        });
                        for (var a = 0, f = s.length; f > a; a += 1) n = c.swapFile(s[a], i.attr, o)
                    }
                    return n
                }
            }
            ...
            if ("*" === e[0]) return t;
            for (var o = [], r = new RegExp("(^|/)" + e), i = 0, s = t.length; s > i; i += 1) r.test(t[i][n]) && o.push(t[i]);
            return o
            ...
            s.emit("browser:hardReload", {
                scrollPosition: i.getBrowserScrollPosition()
            }), t && i.reloadBrowser()
        }
    }, {
        "./browser.utils": 2,
    ...
    5: [function(t, e, n) {
        ...
        n.events = {}, n.emit = function(t, e) {
            ...
            if (r && r.listeners) {
                o = r.listeners;
                for (var i = 0, s = o.length; s > i; i += 1) o[i](e)
            }
        }, n.on = function(t, e) {
            var o = n.events;
    ...
    6: [function(t, e, n) {
        n._ElementCache = function() {
            ...
            function e(e, n) {
                ...
                var r = t.getData(e);
                0 === r.handlers[n].length && (delete r.handlers[n], document.removeEventListener ? e.removeEventListener(n, r.dispatcher, !1) : document.detachEvent && e.detachEvent("on" + n, r.dispatcher)), o(r.handlers) && (delete r.handlers, delete r.dispatcher), o(r) && t.removeData(e)
            }
            var o = 1;
            this.addEvent = function(e, r, i) {
                var s = t.getData(e);
                s.handlers || (s.handlers = {}), s.handlers[r] || (s.handlers[r] = []), i.guid || (i.guid = o++), s.handlers[r].push(i), s.dispatcher || (s.disabled = !1, s.dispatcher = function(t) {
                    if (!s.disabled) {
                        t = n._fixEvent(t);
                        var o = s.handlers[t.type];
                        if (o)
                            for (var r = 0; r < o.length; r++) o[r].call(e, t)
                    }
                }), 1 == s.handlers[r].length && (document.addEventListener ? e.addEventListener(r, s.dispatcher, !1) : document.attachEvent && e.attachEvent("on" + r, s.dispatcher))
            }, this.removeEvent = function(n, o, r) {
                var i = t.getData(n);
                if (i.handlers) {
                    var s = function(t) {
                        i.handlers[t] = [], e(n, t)
                    ...
                    if (o) {
                        var c = i.handlers[o];
                        if (c) {
                            if (!r) return void s(o);
                            if (r.guid)
                                for (var a = 0; a < c.length; a++) c[a].guid === r.guid && c.splice(a--, 1);
                            e(n, o)
                        }
                    } else
                        for (var l in i.handlers) s(l)
                }
        ...
        var o = new n._ElementCache,
            r = new n._EventManager(o);
        r.triggerClick = n.triggerClick, n.manager = r
    }, {}],
    7: [function(t, e, n) {
        "use strict";
        var o = "click",
        ...
        n.canEmitEvents = !0, n.init = function(t, e) {
            ...
            return function(e) {
                if (n.canEmitEvents) {
                    ...
                    if ("checkbox" === r.type || "radio" === r.type) return void t.utils.forceChange(r);
                    t.socket.emit(o, t.utils.getElementData(r))
                } else n.canEmitEvents = !0
            }
        }, n.socketEvent = function(t, e) {
            return function(o) {
                if (!t.canSync(o, r) || t.tabHidden) return !1;
                var i = t.utils.getSingleElement(o.tagName, o.index);
                i && (n.canEmitEvents = !1, e.triggerClick(i))
            }
        }
    }, {}],
    8: [function(t, e, n) {
        "use strict";
        var o = "input:text",
            r = "ghostMode.forms.inputs";
        n.canEmitEvents = !0, n.init = function(t, e) {
            e.addEvent(document.body, "keyup", n.browserEvent(t)), t.socket.on(o, n.socketEvent(t, e))
        }, n.browserEvent = function(t) {
            return function(e) {
                var r, i = e.target || e.srcElement;
                n.canEmitEvents ? ("INPUT" === i.tagName || "TEXTAREA" === i.tagName) && (r = t.utils.getElementData(i), r.value = i.value, t.socket.emit(o, r)) : n.canEmitEvents = !0
            }
        }, n.socketEvent = function(t) {
            return function(e) {
                if (!t.canSync(e, r)) return !1;
    ...
    9: [function(t, e, n) {
        ...
        n.plugins = {
            ...
            var r = !0,
                i = t.options.ghostMode.forms;
            i === !0 && (r = !1);
            for (var s in n.plugins) r ? i[s] && o(s) : o(s)
        }
    }, {
    ...
    10: [function(t, e, n) {
        "use strict";
        var o = "form:submit",
            r = "ghostMode.forms.submit";
        n.canEmitEvents = !0, n.init = function(t, e) {
            var r = n.browserEvent(t);
            e.addEvent(document.body, "submit", r), e.addEvent(document.body, "reset", r), t.socket.on(o, n.socketEvent(t, e))
        }, n.browserEvent = function(t) {
            return function(e) {
                if (n.canEmitEvents) {
                    var r = e.target || e.srcElement,
                        i = t.utils.getElementData(r);
                    i.type = e.type, t.socket.emit(o, i)
                } else n.canEmitEvents = !0
            }
        }, n.socketEvent = function(t) {
            return function(e) {
    ...
    11: [function(t, e, n) {
        "use strict";
        var o = "input:toggles",
            r = "ghostMode.forms.toggles";
        n.canEmitEvents = !0, n.init = function(t, e) {
            var r = n.browserEvent(t);
            n.addEvents(e, r), t.socket.on(o, n.socketEvent(t, e))
        }, n.addEvents = function(t, e) {
            function n(n) {
                for (var o = 0, r = n.length; r > o; o += 1) t.addEvent(n[o], "change", e)
            }
            ...
            return function(e) {
                if (n.canEmitEvents) {
                    var r, i = e.target || e.srcElement;
                    ("radio" === i.type || "checkbox" === i.type || "SELECT" === i.tagName) && (r = t.utils.getElementData(i), r.type = i.type, r.value = i.value, r.checked = i.checked, t.socket.emit(o, r))
                } else n.canEmitEvents = !0
            }
        }, n.socketEvent = function(t) {
            return function(e) {
    ...
    12: [function(t, e, n) {
        ...
        n.plugins = {
            ...
            for (var e in n.plugins) t.options.ghostMode[e] && n.plugins[e].init(t, o)
        }
    }, {
        "./events": 6,
        "./ghostmode.clicks": 7,
    ...
    13: [function(t, e, n) {
        ...
        var o = "browser:location",
            r = "ghostMode.location";
        n.canEmitEvents = !0, n.init = function(t) {
            t.socket.on(o, n.socketEvent(t))
        }, n.socketEvent = function(t) {
            return function(e) {
                return t.canSync(e, r) ? void(e.path ? n.setPath(e.path) : n.setUrl(e.url)) : !1
            }
        }, n.setUrl = function(t) {
            window.location = t
    ...
    14: [function(t, e, n) {
        ...
        n.canEmitEvents = !0, n.init = function(t, e) {
            function s(i, s) {
                c[i] && c[i].length && "querySelectorAll" in document && o.forEach(c[i], function(i) {
                    var c = document.querySelectorAll(i) || [];
                    o.forEach(c, function(i) {
                        var c = o.getElementData(i);
                        c.cacheSelector = c.tagName + ":" + c.index, c.map = s, a[c.cacheSelector] = i, e.addEvent(i, r, n.browserEventForElement(t, i, c))
                    })
                })
            }
            o = t.utils;
            var c = t.options;
            e.addEvent(window, r, n.browserEvent(t)), t.socket.on(r, n.socketEvent(t));
            var a = {};
            s("scrollElements", !1), s("scrollElementMapping", !0), t.socket.on(i, n.socketEventForElement(t, a))
        }, n.socketEvent = function(t) {
            return function(e) {
                if (!t.canSync(e, s)) return !1;
                var r = o.getScrollSpace();
                return n.canEmitEvents = !1, t.options && t.options.scrollProportionally ? window.scrollTo(0, r.y * e.position.proportional) : window.scrollTo(0, e.position.raw.y)
            }
            ...
            return function(o) {
                ...
                return t.canSync(o, s) ? (n.canEmitEvents = !1, o.map ? Object.keys(e).forEach(function(t) {
                    r(t, o.position)
                }) : void r(o.elem.cacheSelector, o.position)) : !1
            }
        }, n.browserEventForElement = function(t, e, o) {
            return function() {
                var r = n.canEmitEvents;
                r && t.socket.emit(i, {
    ...
    15: [function(t, e, n) {
        ...
        n.init = function(t) {
            ...
            if (!e.client) {
                e.client = !0;
                var n = new s(t);
                c.init(n), i.init(n), r.init(n), t.notify && r.flash("Connected to BrowserSync")
            }
            u || (o.on("disconnect", function() {
                t.notify && r.flash("Disconnected from BrowserSync"), l = !0
            }), u = !0)
    ...
    16: [function(t, e, n) {
        "use strict";
        var o, r, i, s = (t("./ghostmode.scroll"), t("./browser.utils")),
            c = {
                display: "none",
                padding: "15px",
        ...
        n.init = function(t) {
            ...
            var e = c;
            if (r.notify.styles)
                if ("[object Array]" === Object.prototype.toString.call(r.notify.styles)) e = r.notify.styles.join(";");
                else
                    for (var i in r.notify.styles) r.notify.styles.hasOwnProperty(i) && (e[i] = r.notify.styles[i]);
            ...
            return function(e) {
                if (t.options.notify || e.override) {
            ...
            var o = n.getElem(),
                r = s.getBody();
            return o ? (o.innerHTML = t, o.style.display = "block", r.appendChild(o), i && (clearTimeout(i), i = void 0), i = window.setTimeout(function() {
                o.style.display = "none", o.parentNode && r.removeChild(o)
            }, e || 2e3), o) : !1
        }
    }, {
        "./browser.utils": 2,
